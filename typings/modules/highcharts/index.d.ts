...
// Source: https://raw.githubusercontent.com/Tapad/typed-highcharts/e4a771c4da9e6348105bcde14327b917750151a7/highcharts.d.ts
 ...
 * @since 4.2.0
 */
export function chart(options: Options, callback?: (chart: ChartObject) => void): ChartObject;
/**
 * As Highcharts.Chart, but without need for the new keyword.
 * @since 4.2.0
 */
export function chart(renderTo: string | HTMLElement, options: Options, callback?: (chart: ChartObject) => void): ChartObject;
/**
 ...
 * @return {string}
 */
export function dateFormat(format: string, time?: number, capitalize?: boolean): string;
/**
 ...
 * of the date.
 */
export let dateFormats: DateFormatSpecifiers;
/**
 ...
 * @return {string}
 */
export function numberFormat(value: number, decimals?: number, decimalPoint?: string, thousandsSep?: string): string;
/**
 ...
 * @return {Options}
 */
export function setOptions(options: GlobalOptions): Options;
/**
