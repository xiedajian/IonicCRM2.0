...
/**
 * Generated class for the TrackingLogPage page.
 *
...
export class TrackingLogPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public interface_lists: InterfaceLists, public networkSer: NetworkSer, public popser: PopSer, public events: Events) {
  }
