...
/**
 * Generated class for the LogSavingPage page.
 *
...
export class LogSavingPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    if(this.TrackLog.contactType==2){
  ...
  LogSaveObj = {//保存日志弹窗内容
    title: '<div class="content_img"><img  src="assets/img/saveLog.png" class="img"/></div>',
