...
export class AccountDetailsPage {
  ...
  getbuyPeople() {
    if (this.VipBuyCount <= 100) {//人数未满100人
      ...
      for (let i = 0; i < 10; i++) {
        this.src[i] = i < num ? './assets/img/gust_4.png' : './assets/img/gust_5.png';
      }
      if (extra != 0) {
        this.src[num] = './assets/img/gust_extra.png';//未满10人
      }
    } else {
      this.eachPicNum = 100;
      ...
      for (let i = 0; i < 10; i++) {
        this.src[i] = i < num ? './assets/img/full_100.png' : './assets/img/gust_5.png';
      }
      if (extra != 0) {
        this.src[num] = './assets/img/Less_than_100.png';//未满100人
      }
    }
  }

  go_trackLog() {
    this.navCtrl.push('TrackingLogPage');
  }
